  ...
  return (
    <div className="bg-[#F8FAFD] min-h-screen">
      {/* ──────────────────────────────────────────────
          ...
          ────────────────────────────────────────────── */}
      <section className="relative min-h-[48vh] flex items-center bg-[#EAF2F8] text-[#0B1220] overflow-hidden">
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/82 to-white/30 pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-t from-white/85 via-transparent to-white/20 pointer-events-none" />

        <div className="container-main relative z-10 py-20 md:py-28 max-w-7xl">
          ...
          >
            <div>
              <div className="text-3xl font-heading font-extrabold text-[#0066FF]">&lt; 2h</div>
              <div className="text-xs text-[#64748B] mt-1 font-medium">Average Response Time</div>
            </div>
            <div>
              <div className="text-3xl font-heading font-extrabold text-[#0B1220]">100%</div>
              <div className="text-xs text-[#64748B] mt-1 font-medium">Milestone-Based Billing</div>
            </div>
            <div>
              <div className="text-3xl font-heading font-extrabold text-emerald-600">Zero</div>
              <div className="text-xs text-[#64748B] mt-1 font-medium">Vendor Lock-In (100% IP)</div>
            </div>
            <div>
              <div className="text-3xl font-heading font-extrabold text-[#0B1220]">NDA</div>
              <div className="text-xs text-[#64748B] mt-1 font-medium">Mutual NDA on Request</div>
            </div>
          </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="lg:col-span-6 rounded-3xl bg-white/95 border border-white/70 p-6 sm:p-8 lg:p-10 shadow-[0_24px_60px_rgba(11,18,32,0.16)] backdrop-blur-md"
            >
              <div className="mb-6 pb-5 border-b border-[#E2E8F0]">
                <span className="text-xs font-bold tracking-[0.18em] text-[#0066FF] uppercase mb-1.5 block">PROJECT INQUIRY</span>
                <h2 className="text-2xl font-heading font-extrabold text-[#0B1220]">Tell us about your vision</h2>
                <p className="text-xs text-[#64748B] mt-2 leading-relaxed">Receive a technical review and clear next steps within 24 hours.</p>
              </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container-main max-w-[1440px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                <div className="w-full flex items-center gap-4 p-4 rounded-2xl bg-white border border-[#E2E8F0] shadow-sm">
                ...
                <div className="w-full overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white shadow-[0_8px_24px_rgba(11,18,32,0.06)]">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-[#F1F5F9]">
                    <div>
                      <p className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-wider">Find Our Office</p>
                      <p className="text-sm font-bold text-[#0B1220] mt-0.5">Sector 8, Noida</p>
                    </div>
                    <a
                      href="https://www.google.com/maps/search/?api=1&query=E-22B%204th%20Floor%20Sector%208%20Noida"
                      target="_blank"
                  ...
                  <iframe
                    title="CSA Technologies CO office location"
                    src="https://www.google.com/maps?q=E-22B%204th%20Floor%20Sector%208%20Noida&output=embed"
                    className="w-full h-56 grayscale-[0.15]"
                    loading="lazy"
